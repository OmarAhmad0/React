...
function Boutton({ children, onClick }) {
  return (
...
export default function App() {
  ...
  function handleSpilteBill(value) {
    setFriend((friends) =>
      friends.map((friend) =>
  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        <Boutton onClick={handleShowAddFriend}>
...
function Friend({ friend, onSelection, selectedFriend }) {
  ...
  return (
    <li className={isSelected ? "selected" : ""}>
      ...
      <Boutton onClick={() => onSelection(friend)}>
...
function FormSplitBill({ selectedFriend, onSpiltBill }) {
  ...
  function handleSubmit(e) {
    ...
    onSpiltBill(whoIsPaid === "user" ? paidByFriend : -paidByUser);
  }
